...
1. **poem.md** — The original poem
2. **lighthouse-signal.opus** — TTS audio reading via ElevenLabs
...
- **Recraft V3 SVG** — Tried to generate lighthouse art, process hung with no output after 2+ minutes. Killed and proceeded without visual.
